...
### Alpha 1.21 Update —— 2019.3.1 16:39

1. 修复了发布问题时上传图片失败的bug

2. 修复了进入问题详情界面后自动弹出键盘的bug

3. 修复了在NaviagtionView中点击登录登陆成功或者登录界面的注册成功后，不会及时更改NaviagtionView的用户id的bug

4. 修复了在NaviagtionView中点击登录界面的注册页面并注册成功后（即用户头像未设置），NaviagtionView中的头像为空的bug
