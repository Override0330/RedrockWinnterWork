...
public class FrontEndNewsFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case INITRECYCLERVIEW:
                    RecyclerView recyclerView = NewsView.findViewById(R.id.rl_gank_frontend);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        NewsView = inflater.inflate(R.layout.gank_frontend_fragment,container,false);
        linearLayoutManager = new LinearLayoutManager(this.getContext());
        gankNewsInitHelper = new GankNewsInitHelper("前端",this.getContext());
