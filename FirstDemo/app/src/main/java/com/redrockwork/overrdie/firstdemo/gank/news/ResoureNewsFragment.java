...
public class ResoureNewsFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case INITRECYCLERVIEW:
                    RecyclerView recyclerView = NewsView.findViewById(R.id.rl_gank_resoure);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        NewsView = inflater.inflate(R.layout.gank_resoure_fragment,container,false);
        linearLayoutManager = new LinearLayoutManager(this.getContext());
        gankNewsInitHelper = new GankNewsInitHelper("拓展资源",this.getContext());
