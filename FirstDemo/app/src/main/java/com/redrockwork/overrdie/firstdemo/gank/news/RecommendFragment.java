...
public class RecommendFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case INITRECYCLERVIEW:
                    RecyclerView recyclerView = NewsView.findViewById(R.id.rl_gank_recommand);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        NewsView = inflater.inflate(R.layout.gank_recommand_fragment,container,false);
        linearLayoutManager = new LinearLayoutManager(this.getContext());
        gankNewsInitHelper = new GankNewsInitHelper("瞎推荐",this.getContext());
