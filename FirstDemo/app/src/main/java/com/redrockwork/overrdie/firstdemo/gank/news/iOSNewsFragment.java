...
public class iOSNewsFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case INITRECYCLERVIEW:
                    RecyclerView recyclerView = NewsView.findViewById(R.id.rl_gank_ios);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        NewsView = inflater.inflate(R.layout.gank_ios_fragment,container,false);
        linearLayoutManager = new LinearLayoutManager(this.getContext());
        gankNewsInitHelper = new GankNewsInitHelper("iOS",this.getContext());
