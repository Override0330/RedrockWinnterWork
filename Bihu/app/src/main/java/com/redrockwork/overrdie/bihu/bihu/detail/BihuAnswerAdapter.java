...
public class BihuAnswerAdapter extends RecyclerView.Adapter<BihuAnswerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.content.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                textViewLongClickListener.onTextViewLongClickListener(position,viewHolder);
                return true;
            }
        });
    ...
    public interface TextViewLongClickListener {
        void onTextViewLongClickListener(int position, ViewHolder viewHolder);
    }

    private TextViewLongClickListener textViewLongClickListener = null;

    public void setTextViewLongClickListener(TextViewLongClickListener textViewLongClickListener) {
